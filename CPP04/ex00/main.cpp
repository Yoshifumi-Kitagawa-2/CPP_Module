...
/*   Updated: 2024/01/08 19:02:29 by yokitaga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << "==========Test1 : success override and delete because of virtual function and virtual destructor==========" << std::endl;
	...
	std::cout << "==========Test2 : failed override and delete because of non-virtual function and non-virtual destructor==========" << std::endl;
